                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="flex gap-2 justify-center">
                                ...
                                <button onclick="editTeamStatus({{ $team->id }}, '{{ $team->status }}')" class="text-yellow-500 hover:text-yellow-700 bg-yellow-50 hover:bg-yellow-100 p-2 rounded-lg transition" title="Update Status">
