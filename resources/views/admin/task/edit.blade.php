...
<form id="editTaskForm" action="{{ route('admin.event.tasks.update', ['event' => $event->id, 'task' => $task->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" id="submitBtn" class="px-5 py-2.5 bg-[#EC46A4] hover:bg-[#d63f93] text-white font-semibold rounded-lg shadow-md transition disabled:opacity-70 disabled:cursor-not-allowed">Simpan Perubahan</button>
            </div>
        </div>
    </form>
</div>
