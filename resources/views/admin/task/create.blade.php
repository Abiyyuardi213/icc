...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl">
    <form action="{{ route('admin.event.tasks.store', $event->id) }}" method="POST">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" class="px-5 py-2.5 bg-[#EC46A4] hover:bg-[#d63f93] text-white font-semibold rounded-lg shadow-md transition">Simpan Tugas</button>
            </div>
        </div>
    </form>
</div>
